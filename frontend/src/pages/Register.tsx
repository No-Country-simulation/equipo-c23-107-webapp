    ...
    <Layout>
      <div className="flex items-center justify-center min-h-screen ">
        <div className="w-full max-w-md p-8  rounded-lg  border-2 border-black">
          <h2 className="mb-6 text-lg font-bold text-center text-gray-800">Ingresa tus datos:</h2>
          <form className="flex flex-col items-center space-y-4">
            <div className="max-w-72">
              ...
              <div className="w-full">
                <label htmlFor="confirm-password" className="block text-lg font-bold text-black">
            ...
            <button
              type="button"
              className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90  focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  me-2 mb-2"
            >
